...
class Settings:
    ...
    # The manually generated long-lived Dhan Access Token is entered here.
    # The variable name is retained for deployment compatibility; no separate
    # DHAN_ACCESS_TOKEN variable is read or generated by the application.
    ...
    def dhan_market_data_token(self) -> str:
        """Return the manually entered Dhan token from DHAN_API_KEY only."""
